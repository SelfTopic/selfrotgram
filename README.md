...
Обновить: `pip install -U selfrotgram` или `poetry update selfrotgram`. Poetry запишет `^0.1.3`,
то есть `>=0.1.3,<0.2.0`: пока версия `0.x`, ломающие изменения увеличивают минор (см.
...
poetry add "git+https://github.com/SelfTopic/selfrotgram.git#v0.1.3"
```
